Our objective is to compare different pre trained models to detect fires (specifically forest fires) and conclude which model is most accurate amongst them. 
